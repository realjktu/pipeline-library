    ...
    if (optional == false || testTarget(saltId, target)){
        if (retries > 0){
            ...
            retry(retries){
                ...
                common.infoMsg("Ping command 2 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)
                common.infoMsg("Ping command 3 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)
                common.infoMsg("Ping command 4 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)
                common.infoMsg("Ping command 5 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)
                common.infoMsg("Ping command 6 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)
                common.infoMsg("Ping command 7 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)
                common.infoMsg("Ping command 8 ")
                pingOut = runSaltCommand(saltId, 'local', ['expression': target, 'type': 'compound'], 'test.ping', null, null, null, -1, read_timeout)
                checkResult(pingOut, failOnError, output)                
